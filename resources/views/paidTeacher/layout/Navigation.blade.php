	...
	<nav class="vertical_nav">
		<div class="left_section menu_left" id="js-menu" >
			<div class="left_section">
				<ul>
					<li class="menu--item">
						<a href="{{url('paidTeacher/home')}}" class="menu--link active" title="Home">
							<i class='uil uil-home-alt menu--icon'></i>
							<span class="menu--label">Home</span>
						</a>
					</li>
					<li class="menu--item">
						<a href="{{url('paidTeacher/explore')}}" class="menu--link" title="Explore">
							<i class='uil uil-search menu--icon'></i>
							<span class="menu--label">Explore</span>
						</a>
					</li>
					<li class="menu--item">
						<a href="{{url('paidTeacher/RequestCourse')}}" class="menu--link" title="Request Course">
							<i class='uil uil-home-alt menu--icon'></i>
							<span class="menu--label">Request Course</span>
						</a>
					</li>
					<li class="menu--item">
						<a href="#" class="menu--link" title="Student List">
							<i class='uil uil-kayak menu--icon'></i>
							<span class="menu--label">Student List</span>
						</a>
					</li>
					<li class="menu--item">
						<a href="{{url('paidTeacher/live_streams')}}" class="menu--link" title="Live Streams">
							<i class='uil uil-kayak menu--icon'></i>
					...
					<li class="menu--item">
						<a href="{{url('paidTeacher/studentReview')}}" class="menu--link" title="Reviews">
					...
					<li class="menu--item">
						<a href="categories.html" class="menu--link" title="Syllabus">
							<i class='uil uil-layers menu--icon'></i>
							<span class="menu--label">Syllabus</span>
						</a>
					</li>
					...
					<li class="menu--item">
						...
						<i class='uil uil-clipboard-alt menu--icon'></i>
							<span class="menu--label">Upload Test</span>
						</a>
					</li>
					<!--<li class="menu--item">
						...
						<ul class="sub_menu">
							...
							<li class="sub_menu--item">
								<a href="#" class="sub_menu--link"> Create Test</a>
							</li>
						</ul>
					</li>-->
					<!--<li class="menu--item">
			...
			<div class="left_section">
				<h6 class="left_title">Teachers</h6>
				<ul>
					<!--<li class="menu--item">
					...
					<li class="menu--item">
						<a href="all_instructor.html" class="menu--link" title="Browse Instructors">
						  ...
						  <span class="menu--label">Browse Teachers</span>
						</a>
					</li>
				</ul>
			</div>
